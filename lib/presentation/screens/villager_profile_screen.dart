...
class VillagerProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder(
      valueListenable: context.read<GetVillagersCubit>().villagers,
      builder: (context, villagers, child) {
        // Get the updated villager data
        final updatedVillager = villagers.firstWhere(
          (v) => v.id == villager.id,
          orElse: () => villager,
        );
        ...
        return CupertinoPageScaffold(
          ...
          navigationBar: CupertinoNavigationBar(
            backgroundColor: ColorConstants.backgroundColor(context),
            middle: Text(updatedVillager.name),
          ),
          child: SafeArea(
            child: ListView(
              ...
              children: [
                  ...
                  child: Column(
                    children: [
                      Container(
                        ...
                        child: Center(
                          child: Text(
                            updatedVillager.name.characters.first.toUpperCase(),
                            style: TextStyle(
                              color: ColorConstants.primaryColor(context),
                              fontSize: 32,
                      ...
                      Text(
                        '${TextConstants.villagerBalance}${updatedVillager.balanceInRs.toStringAsFixed(2)}',
                        style: TextStyle(
                ...
                const SizedBox(height: 16),
                TransactionList(villagerId: updatedVillager.id),
              ],
            ),
          ),
        );
